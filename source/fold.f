     ...
     1         , emid_hld(1001,15)
       ...
       character*1 char
       character*2256 FMT9011, FMT8011, FMT5311, FMT9311
       sum = 0.0
       sum2 = 0.0
       sum3 = 0.0
       tot1 = 0.0
...
c       write (nt6, 3409 ) FMT9011
 3409  format (1x, 'FMT9011: ', a)
       write (FMT8011, '("/,/,/, 2x, 24Hspectrum folding option ,/,
     1  15x, 16Hsource file:    , a",I3.3,",/,15x, 16Hresponse file:  ,
     2  a",I3.3,",/, 15x, 18Hcorrection file:   , a",I3.3,",/,/,10x, 
     3  5H mid , 10x, 6Hsource, 9x, 8Hresponse, 9x, 7Hfolding,7x, 
     4  9Hincrement, /,9x, 6Henergy, 10x, 6Hnumber, 9x, 8Hfunction,2x,
     5  /,9x, 5H(mev), 10x, 8Hfraction, /" )') lensrc, lenrsp, lencor
c       write (nt6, 3408 ) FMT8011
 3408  format (1x, 'FMT8011: ', a)
